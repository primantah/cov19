...
d2 = '23 May 2020';   % hari peak of new cases of covid di indo
d6 = '24 May 2020';   % hari ini hehe
dForm = 'dd mmm yyyy';
t = abs(datenum(d1,dForm) - datenum(d2,dForm)); 


%% GRAFIK INFECTED CASES
a = 0.10066; %% y = (a) x^(b) BENTUK UMUM DARI EXPONEN
b = 2.79430;
...
%% GRAFIK SOLVED CASES
c = 0.00127; %% y = (c) x^(d) BENTUK UMUM DARI EXPONEN
d = 3.52371;
...
hold on;
    ...
    d3 = x2b(indexPeak); % hari inf peak
    d4 = d3+7;              % hari ke PSBB kelar
...
fprintf('Akhir Lockdown --> '); disp(datestr((d4+datenum(d1,dForm)),dForm));
